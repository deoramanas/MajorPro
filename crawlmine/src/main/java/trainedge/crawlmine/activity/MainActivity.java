...
import static trainedge.crawlmine.R.id.imageView;
import static trainedge.crawlmine.R.id.imgIcon;
...
public class MainActivity extends BaseActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //round imageview of app icon
        imgIcon = (ImageView) findViewById(R.id.imgIcon);
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.my_logo);
